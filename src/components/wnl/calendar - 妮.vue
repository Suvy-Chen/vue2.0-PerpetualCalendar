...
export default {
	...
	methods: {
		initData: function(cur) {  // cur 是日期类型
			...
			console.log('date：',date);//Tue Aug 01 2017 08:00:00 GMT+0800 (中国标准时间)
			...
			console.log("str",str);//2017-08-01
			...
			//其他周
			let str2 = this.formatDate(this.currentYear , this.currentMonth+1 , this.currentDay);
			let d2=new Date(str2)
			d2.setDate(0);
			if((this.currentMonth+1)==13){
				str2 = this.formatDate(this.currentYear , 1 , this.currentDay);
				d2=new Date(str2)
				d2.setDate(0);
